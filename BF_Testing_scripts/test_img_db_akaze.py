...
img = cv2.imread('../images/testBooks/prayer/1.jpg', 0)
# print img
...
pkl_file = open('../database/book_image_dabase_many_akaze.pkl', 'rb')
# get zipped object
...
with open('../database/Results_Comparison/akaze.csv', 'a') as csvfile:
