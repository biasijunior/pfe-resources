...
img = cv2.imread('../images/testBooks/malcomx/1.jpg', 0)
# print img
...
pkl_file = open('../database/book_image_dabase_many_surf.pkl', 'rb')
# get zipped object
...
with open('../database/Results_Comparison/surf.csv', 'a') as csvfile:
