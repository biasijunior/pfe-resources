...
app = Flask(__name__)
c = clusters.read_clusters('akaze_cluster_flann.pkl')
center_index = clusters.read_clusters('akaze_centers_flann.pkl')
image_descriptors = open('../database/akaze_descriptors_dic.pkl', 'rb')
